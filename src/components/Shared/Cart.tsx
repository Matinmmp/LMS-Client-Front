'use client'
import { addCourse, deleteCourse, hydrateCart } from "@/src/redux/cart/cartSlice";
import { encodeTitle, numberSeparator, toPersianNumber } from "@/src/utils/functions";
...
export const Cart = () => {
    ...
    return (
        <div ref={cartRef} className="relative cursor-pointer">
            ...
            {open && (
                <div className="w-[330px] md:w-96 absolute -left-16 md:-left-6 transform">
                            ...
                            <div className="flex flex-col">
                                ...
                                </div>
                                {
                                    ...
                                    <div className='w-full p-4 flex flex-col gap-2 justify-center items-center'>
                                        ...
                                        <p dir="rtl" className="font-semibold text-secondary-500">درحال دریافت سبد خرید.</p>
                                    </div>
                                }

                                {!cartCourses.isLoading && !courseIds?.length ?
