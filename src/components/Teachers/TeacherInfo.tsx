            ...
            <div className="w-full pb-12 p-4 lg:p-8 bg-white dark:bg-slate-900/ dark:bg-[#131d35] dark:opacity-85 dark:backdrop-blur-md shadow-medium rounded-2xl">
                ...
                <div className="w-full h-48 md:h-64 lg:h-[27rem] relative rounded-2xl ">
                    <Image className="w-full h-full -mt-24 md:-mt-32 lg:-mt-40 rounded-2xl object-cover object-center shadow-medium" priority={true}
                        width={1000} height={1000} alt="virtual learn hero" src={"https://buckettest.storage.c2.liara.space/images/teacher2.png"} />
                </div>
                ...
                <div className="w-full mt-10 flex flex-col items-center lg:items-start lg:flex-row justify-between">
                    ...
                    <div className="order-2 lg:order-1 mt-8 lg:mt-4 text-center lg:text-left" style={{ lineBreak: 'anywhere' }}>
                        <h1 className={clsx(title({ color: 'secondary' }), 'inline w-full text-left text-2xl md:text-4xl lg2:text-[2.5rem] xl:text-5xl !font-bold md:leading-[3.2rem] whitespace-nowrap')}>
                            {data.faName}

                        </h1>
                        <h2 className={clsx(title({ color: 'secondary' }), 'inline w-full text-left text-2xl md:text-4xl lg2:text-[2.5rem] xl:text-5xl !font-bold md:leading-[3.2rem] whitespace-nowrap')}>
                            {` (${data.engName}) `}

                        </h2>
                    </div>

                    <Avatar className="order-1 lg:order-2 min-h-28 min-w-28 md:min-h-36 md:min-w-36 lg:min-h-52 lg:min-w-52 -mt-20 md:-mt-28 lg:-mt-20 lg:me-6 shadow-[0_0_15px_0_#42C0F4] " size="lg" radius="full" isBordered color="secondary" src={data.avatar.imageUrl} />
