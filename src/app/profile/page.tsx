    ...
    return (
        <div className="w-full">
            ...
            <div className="mt-16 lg:mt-28">
                <div className="items-center grid lg:grid-cols-2 gap-x-4 gap-y-6">
                    ...
                    <Input size="lg" color="secondary" variant="bordered" type='tel' label="َشماره تلفن" labelPlacement={'outside'} placeholder={!user?.phone && !loading ? 'وارد نشده' : ''} value={user?.phone} radius="sm" dir="rtl"
                        disabled classNames={{ label: 'text-base font-semibold text-secondary-400' }}/>
                </div>
            </div>
