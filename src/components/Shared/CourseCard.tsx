...
export const CourseCard = ({ data }: CardProps) => {
    ...
    return (
        <div className="w-full max-w-[25rem] h-[25rem] transition-all  shadow-medium dark:shadow-xl  
        hover:shadow-medium
        ...
        dark:border-1 dark:border-primary-400 bg-white dark:bg-[#212123]/70 dark:backdrop-blur-md dark:backdrop-saturate-150 rounded-md cursor-pointer overflow-hidden  ">
            ...
            <div className="w-full h-full flex flex-col">
                ...
                <div className="p-2 overflow-hidden aspect-video">
...
export const CourseCardLoading = () => {
    return (
        <div className="w-full max-w-[25rem] h-[25rem] shadow-medium
