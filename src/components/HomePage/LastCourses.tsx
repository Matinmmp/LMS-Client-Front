...
const CourseCard = ({ }: CardProps) => {
    return (
        <div className="w-full max-w-[25rem] h-[28rem] border-1 border-[#ecf0f4]   transition-all
        shadow-[0_0_9px_0_#c1c2c4] dark:shadow-[0_0_9px_0_#2b2b2b]  hover:shadow-[0_0_6px_0_#42C0F4] dark:hover:shadow-[0_0_6px_0px_#42C0F4]
                    ...
                    <div className="h-full flex flex-col">
                        ...
                        <div className="px-3 pt-1 flex items-center justify-between gap-0.5">
                            <div className="flex items-center">
                                ...
                                <span className="text-xs font-semibold text-secondary-400">درحال ترجمه</span>
                            </div>
                            <div className="flex items-center gap-1">
                                <span className="pt-1 text-md font-semibold text-warning-400">4.3</span>
                                <FaStar size={20} className="text-warning-400" />
                            </div>
                        </div>

                        <h4 className="mt-2 px-3 text-lg font-semibold hover:text-primary-400 transition-all">آموزش برنامه نویسی Next</h4>
                        ...
                        <div className=" px-3 mt-3 flex items-center gap-4">
                            ...
                            <div className="flex flex-col">
                                <div className="mt-1 flex items-center gap-1">
                                    ...
                                    <span className="text-xs font-semibold text-gray-400">محمد متین محمدی پگا</span>
                                </div>

                                <div className="mt-1 flex items-center gap-1">
                                    <IoIosFilm size={16} className="text-primary-400" />
                                    <span className="text-xs font-semibold text-gray-400">101 درس</span>
                                </div>
                            </div>
                            ...
                            <div className="flex flex-col">
                                <div className="flex items-center gap-1">
                                    ...
                                    <span className="text-xs font-semibold text-gray-400">یودمی</span>
                                </div>
                                <div className="mt-1 flex items-center gap-1">
                                    <WiTime3 size={16} className="text-primary-400" />
                                    <span className="text-xs font-semibold text-gray-400">04:56:30</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="px-3 py-1 mt-auto flex justify-end">
                            <div className="flex items-center gap-2">
                                <span className="text-2xl font-bold">790,00</span>
                                <div className="flex flex-col">
