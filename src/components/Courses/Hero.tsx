            ...
            <div className="pb-10 flex flex-col md2:flex-row justify-between relative z-10">
                <div className="w-full px-4">
                    <div className="w-full mt-4 text-center ">
                        ...
                        جستجوی مقالات برنامه‌نویسی و تکنولوژی
                        </h1>
                        ...
                        <div className="w-full flex flex-col items-center">
                            <h2 className="w-full lg:w-10/12 mt-4 md:mt-10 text-base md:text-xl font-medium leading-8 md:leading-8">
                                ...
                                ، به دنیایی از مقالات آموزشی در حوزه برنامه‌نویسی، توسعه وب، هوش مصنوعی، امنیت سایبری و فناوری اطلاعات دسترسی داشته باشید. موضوع مورد نظر خود را جستجو کنید و جدیدترین مطالب را کشف کنید! 🚀
                            </h2>
