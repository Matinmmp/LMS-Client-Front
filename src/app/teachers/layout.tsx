...
const schema = {
    ...
    "keywords": "آموزش برنامه‌نویسی, ترجمه دوره‌ها, برنامه‌نویسی فارسی, اساتید برتر برنامه‌نویسی, آموزش آنلاین",
    "inLanguage": "fa",
    "alternateName": "آموزش آنلاین برنامه‌نویسی به زبان فارسی با ترجمه اختصاصی از اساتید جهانی",
    "potentialAction": {
        "@type": "SearchAction",
